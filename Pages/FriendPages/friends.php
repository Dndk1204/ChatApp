...
<style>
    ...
    /* NEW CSS: Header cho cột giữa để chứa tiêu đề và nút Refresh */
    .middle-header {
        display: flex;
    ...
    /* Sửa đổi: H2 chỉ còn là tiêu đề con */
    .middle-header h2 {
        margin: 0; 
        font-size: 16px; 
    ...
    /* Thêm animation xoay khi đang tải */
    @keyframes spin {
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="middle">
                <!-- THAY ĐỔI: Thêm div cho header và nút Refresh -->
                <div class="middle-header">
                    <h2>Gợi ý kết bạn</h2>
                    <button id="refreshSuggestionsBtn" title="Tải lại gợi ý">
...
async function loadRequests() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // NEW: Gán sự kiện cho nút Refresh
        if (refreshBtn) {
