...
-- ! thêm cột để thông báo số lượng tài khoản đã tạo;

ALTER TABLE users 
ADD COLUMN LastSeen DATETIME DEFAULT CURRENT_TIMESTAMP AFTER IsOnline;

Update users set AvatarPath = "uploads/default-avatar.jpg"
